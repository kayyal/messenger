...
public class check extends javax.swing.JDialog {
     ...
     */
    public check(java.awt.Frame parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabelUsername.setText("jLabel4");

        jLabelPassword.setText("jLabel5");
        ...
        PicturejLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("resourses\\profilePhoto.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                check dialog = new check(new javax.swing.JFrame(), true);
